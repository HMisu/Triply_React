                ...
                <div className='chat-request-list'>
                    <div className='request-friend-container' onClick={openModal}>
                        ...
                        <div className='request-friend-img-container'>
                            <img className='request-friend-img'
                                 src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR7MnOcQUfqtgTKRpCld7E-_P2JCyF-QMlesD887gUZ6A&s'></img>
                            ...
                            <div className='friend-container'>
                                ...
                                <div className='friend-img-container'>
                                    <img className='friend-img'
                                         src={currentUserName == chat.makerName ? chat.partnerImg : chat.makerImg}></img>
                                </div>
                            </div>
