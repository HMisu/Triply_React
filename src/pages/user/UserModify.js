...
import {deleteProfileImage, updateProfileImage} from '../../apis/userApi';
        ...
        const fetchUserInfo = async () => {
            try {
                ...
                const {
                    userName,
                    userTel,
                    profileImageUrl: serverProfileImageUrl,
                    tags,
                    areaCode,
                    areaName,
                    sigunguCode,
          ...
          />
            ...
            <div className="titlename">
                ...
                <div className="taglocation">
                    {tags.map((tag, index) => (
                        <span key={index} className="Tag tag-color-blue" onClick={() => handleTagRemove(index)}
